...
from ges_neu_api.core.contracts import CatalogServiceContract
from ges_neu_api.core.monitoring import monitor_service_method
from ges_neu_api.core.permissions import ObjectPermissionChecker
from ges_neu_api.modules.auth.models import Usuario

# Define the polymorphic type alias
AnyCatalogoItemModel = Union[
    models.Fabricante,
...
class CatalogItemPermissionChecker(ObjectPermissionChecker):
    ...
    async def check_permission(
        ...
        """
        # Obtener el usuario
        from ges_neu_api.modules.auth.service import UserService
        ...
        #     .where(models.CatalogoItem.id == object_id)
        # )
...
class CatalogosService(CatalogServiceContract):
    """
    ...
    async def _get_fabricante(self, fabricante_id: UUID) -> Optional[models.Fabricante]:
    ...
    async def _get_all_fabricantes(
        self,
        skip: int = 0,
        limit: int = 100,
    ...
    async def _remove_fabricante(self, *, db_obj: models.Fabricante) -> models.Fabricante:
    ...
    async def _get_modelo(self, modelo_id: UUID) -> Optional[models.ModeloNeumatico]:
    ...
    async def _remove_modelo(self, *, db_obj: models.ModeloNeumatico) -> models.ModeloNeumatico:
