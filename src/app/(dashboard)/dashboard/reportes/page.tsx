...
import { FileText, Download, BarChart3, TrendingUp, Truck, CircleDollarSign, Loader2, FileSpreadsheet } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
                        <FileText className="h-8 w-8" /> Reportes
                    </h1>
                    <p className="text-muted-foreground">Generación de reportes PDF y Excel del sistema</p>
                </div>
            ...
            <Card className="border-dashed">
                <CardContent className="py-8 text-center text-muted-foreground">
                    ...
                    <p className="font-medium">Más reportes próximamente</p>
                    <p className="text-sm">Reportes personalizados, programados y comparativos.</p>
                </CardContent>
            </Card>
        </div>
    );
