"""
Modelos finales del módulo de catálogos - Sin duplicados y bien organizados
"""
...
class MotivoDesecho(BaseModel, table=True):
    ...
    requiere_evidencia: bool = Field(sa_column=Column(Boolean, nullable=False, server_default=text("false")), description="Indica si requiere evidencia")
...
class Almacen(BaseModel, table=True):
    ...
    capacidad_maxima: Optional[int] = Field(None, sa_column=Column(Integer), description="Capacidad máxima del almacén")
