...
# ============================================================================
# MODELOS PRINCIPALES DE NEUMÁTICOS
# ============================================================================
...
class ModeloNeumatico(BaseModel, table=True):
    ...
    especificaciones_desgaste: List["EspecificacionDesgaste"] = Relationship(back_populates="modelo_neumatico")
    parametros_rendimiento: List["ParametroRendimientoEsperadoModelo"] = Relationship(back_populates="modelo")
...
class Neumatico(BaseModel, table=True):
    ...
    mediciones_profundidad: List["MedicionProfundidad"] = Relationship(back_populates="neumatico")
    historial_estados: List["HistorialEstadoNeumatico"] = Relationship(back_populates="neumatico")
    garantias: List["GarantiaNeumatico"] = Relationship(back_populates="neumatico")
...
class EventoNeumatico(BaseModel, table=True):
    ...
    # Relaciones
    neumatico: Optional["Neumatico"] = Relationship(back_populates="eventos")
...
class BitacoraOperaciones(BaseModel, table=True):
    ...
    # Relaciones
    operaciones_neumaticos: List["BitacoraOperacionesNeumaticos"] = Relationship(back_populates="operacion")
...
class BitacoraOperacionesNeumaticos(BaseModel, table=True):
    ...
    # Relaciones
    operacion: Optional["BitacoraOperaciones"] = Relationship(back_populates="operaciones_neumaticos")
...
class MedicionProfundidad(BaseModel, table=True):
    ...
    # Relaciones
    neumatico: Optional["Neumatico"] = Relationship(back_populates="mediciones_profundidad")
...
class EspecificacionDesgaste(BaseModel, table=True):
    ...
    # Relaciones
    modelo_neumatico: Optional["ModeloNeumatico"] = Relationship(back_populates="especificaciones_desgaste")
...
class HistorialEstadoNeumatico(BaseModel, table=True):
    ...
    # Relaciones
    neumatico: Optional["Neumatico"] = Relationship(back_populates="historial_estados")
...
class GarantiaNeumatico(BaseModel, table=True):
    ...
    # Relaciones
    neumatico: Optional["Neumatico"] = Relationship(back_populates="garantias")
...
class ParametroRendimientoEsperadoModelo(BaseModel, table=True):
    ...
    # Relaciones
    modelo: Optional["ModeloNeumatico"] = Relationship(back_populates="parametros_rendimiento")
...
class PosicionNeumatico(BaseModel, table=True):
    ...
    lado: str = Field(max_length=13)  # IZQUIERDO, DERECHO
