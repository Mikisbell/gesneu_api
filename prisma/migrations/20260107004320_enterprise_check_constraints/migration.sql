...
CHECK (profundidad_remanente_actual_mm IS NULL OR (profundidad_remanente_actual_mm >= 0 AND profundidad_remanente_actual_mm <= 100));
...
ADD CONSTRAINT chk_odometro_no_negativo 
CHECK (odometro_actual >= 0);
